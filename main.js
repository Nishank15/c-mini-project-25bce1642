...
function __asyncjs__get_input_from_js(buffer,max_size) { return Asyncify.handleAsync(async () => { const input = await window.waitForUserInput(); stringToUTF8(input, buffer, max_size); }); }
